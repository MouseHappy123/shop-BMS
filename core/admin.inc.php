 ...
 */
function checkAdmin($sql, $type, $data)
{
...
function getAdminByPage($page, $pageSize = 2)
{
    ...
    $sql = 'select id,username,email from admin limit ?,?';
    $type = 'ii';
...
function delUser($id)
{
    $sql = 'select face from user where id=?';
    $type = 'i';
    $data = array($id);
